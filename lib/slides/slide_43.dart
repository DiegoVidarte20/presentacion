// lib/slides/slide_43.dart
import 'dart:ui' show ImageFilter;
import 'package:flutter/material.dart';
import 'package:presentacion/ui/footer_band.dart';

class Slide43 extends StatefulWidget {
  const Slide43({super.key});

  @override
  State<Slide43> createState() => _Slide43State();
}

class _Slide43State extends State<Slide43> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    const imgAsset = "assets/slide43/slide43.png"; // <-- tu imagen (la del screenshot)
                  ...
                  child: Column(
                    ...
                    children: [
                      SlideTransition(
                        ...
                        child: _HeaderGlass(
                          scale: s,
                          title: "CTRL X CORE – Abierto y expansible",
                        ),
                      ),
                            ...
                            child: ConstrainedBox(
                              ...
                              child: _GlassCard(
                                ...
                                child: _CroppedImagePanel(
                                  ...
                                  // ✅ esta imagen tiene mucho "aire" blanco:
                                  // recorte más fuerte para que se vea pro y grande
                                  cropLeftFactor: 0.06,
                                  cropRightFactor: 0.02,
                                  cropTopFactor: 0.22,
                                  cropBottomFactor: 0.10,

                                  fit: BoxFit.cover, // ✅ llena el panel
                                ),
                              ),
                            ),
                          ),
