...
class _Slide23State extends State<Slide23> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    const rightImage = "assets/slide23/slide23.png";
                                      ...
                                      children: [
                                        ...
                                        Positioned(
                                          ...
                                          child: _GlassLabelPill(
                                            s: s,
                                            text: "Arquitectura y Ecosistema",
                                          ),
                                        ),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 14 * s),
        Text("Arquitectura basada en controlador",
          ...
          child: _InnerGlassPanel(
            ...
            child: Column(
              ...
              children: [
                _BulletRichGlass(
                  s: s,
                  head: "Extensión individual",
                  body:
                      " mediante módulos de E/S ctrlX locales e interfaces integradas.",
                ),
                SizedBox(height: 10 * s),
                _BulletRichGlass(
                  s: s,
                  head: "Espacio de instalación mínimo",
                  body:
                      " con control integrado compacto de alto rendimiento.",
                ),
                SizedBox(height: 10 * s),
                _BulletRichGlass(
                  s: s,
                  head: "Alta velocidad y máximo rendimiento",
                  body:
                      " con rendimiento multinúcleo y movimientos más rápidos.",
                ),
                SizedBox(height: 10 * s),
                _BulletRichGlass(
                  s: s,
                  head: "Movimiento de alto rendimiento",
                  body:
                      " para máquinas complejas de alta producción.",
                ),
              ],
            ),
          ),
