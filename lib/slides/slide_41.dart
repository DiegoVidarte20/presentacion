// lib/slides/slide_41.dart
import 'dart:ui' show ImageFilter;
import 'package:flutter/material.dart';
import 'package:presentacion/ui/footer_band.dart';

class Slide41 extends StatefulWidget {
  const Slide41({super.key});

  @override
  State<Slide41> createState() => _Slide41State();
}

class _Slide41State extends State<Slide41> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    const imgAsset = "assets/slide41/slide41.png"; // <-- tu imagen del slide 41
                  ...
                  child: Column(
                    ...
                    children: [
                      SlideTransition(
                        ...
                        child: _HeaderGlass(
                          scale: s,
                          title: "CTRL X CORE como PLC maestro",
                        ),
                      ),
                            ...
                            child: ConstrainedBox(
                              ...
                              child: _GlassCard(
                                ...
                                child: _CroppedImagePanel(
                                  ...
                                  // ✅ recorte leve para limpiar bordes
