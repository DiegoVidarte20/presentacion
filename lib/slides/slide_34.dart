// lib/slides/slide_34.dart
import 'dart:ui' show ImageFilter;
import 'package:flutter/material.dart';
import 'package:presentacion/ui/footer_band.dart';

class Slide34 extends StatefulWidget {
  const Slide34({super.key});

  @override
  State<Slide34> createState() => _Slide34State();
}

class _Slide34State extends State<Slide34> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // overlay suave para que el texto reviente
          Positioned.fill(
            child: DecoratedBox(
                  ...
                  child: SlideTransition(
                    ...
                    child: Center(
                      child: ConstrainedBox(
                        constraints: BoxConstraints(maxWidth: 1100 * s),
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              // Barra de acento (bien "ctrlX vibes")
              Container(
                height: 8 * s,
              ...
              // micro tagline opcional (queda fino)
              Opacity(
                opacity: 0.86,
                child: Text(
                  "One platform. One engineering. One experience.",
...
// Texto con stroke + fill (sin depender de paquetes)
