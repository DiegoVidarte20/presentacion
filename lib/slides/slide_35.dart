// lib/slides/slide_35.dart
import 'dart:ui' show ImageFilter;
import 'package:flutter/material.dart';
import 'package:presentacion/ui/footer_band.dart';

class Slide35 extends StatefulWidget {
  const Slide35({super.key});

  @override
  State<Slide35> createState() => _Slide35State();
}

class _Slide35State extends State<Slide35> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    const imgAsset = "assets/slide35/slide35.png";
                  ...
                  child: Column(
                    ...
                    children: [
                      SlideTransition(
                        ...
                        child: _HeaderGlass(
                          scale: s,
                          title: "CTRL X CORE – Arquitectura uniforme",
                        ),
                      ),
                      ...
                      Expanded(
                        child: SlideTransition(
                          ...
                          child: _GlassCard(
                            ...
                            child: _BigImagePanel(s: s, asset: imgAsset),
                          ),
                        ),
                      ),
                    ],
...
class _BigImagePanel extends StatelessWidget {
  final double s;
  final String asset;
  const _BigImagePanel({required this.s, required this.asset});
