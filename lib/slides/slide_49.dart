// lib/slides/slide_49.dart
import 'dart:ui' show ImageFilter;
import 'package:flutter/material.dart';
import 'package:presentacion/ui/footer_band.dart';

class Slide49 extends StatefulWidget {
  const Slide49({super.key});

  @override
  State<Slide49> createState() => _Slide49State();
}

class _Slide49State extends State<Slide49> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    const imgAsset = "assets/slide49/slide49.png"; // <-- tu imagen
                  ...
                  child: Column(
                    ...
                    children: [
                      SlideTransition(
                        ...
                        child: _HeaderGlass(
                          scale: s,
                          title: "CTRL X CORE – Administración en línea",
                        ),
                      ),
                            ...
                            child: ConstrainedBox(
                              ...
                              child: _GlassCard(
                                ...
                                child: _CroppedImagePanel(
                                  ...
                                  // ✅ recorte leve para que llene más sin cortar el título de la imagen
                                  cropLeftFactor: 0.015,
                                  cropRightFactor: 0.015,
                                  cropTopFactor: 0.02,
