// lib/slides/slide_37.dart
import 'dart:ui' show ImageFilter;
import 'package:flutter/material.dart';
import 'package:presentacion/ui/footer_band.dart';

class Slide37 extends StatefulWidget {
  const Slide37({super.key});

  @override
  State<Slide37> createState() => _Slide37State();
}

class _Slide37State extends State<Slide37> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    const imgAsset = "assets/slide37/slide37.png"; // <-- tu imagen (ajusta ruta)
                  ...
                  child: Column(
                    ...
                    children: [
                      SlideTransition(
                        ...
                        child: _HeaderGlass(
                          scale: s,
                          title: "CTRL X CORE como dispositivo límite y plataforma abierta",
                        ),
                      ),
