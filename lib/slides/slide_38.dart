// lib/slides/slide_38.dart
import 'dart:ui' show ImageFilter;
import 'package:flutter/material.dart';
import 'package:presentacion/ui/footer_band.dart';

class Slide38 extends StatefulWidget {
  const Slide38({super.key});

  @override
  State<Slide38> createState() => _Slide38State();
}

class _Slide38State extends State<Slide38> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    const imgAsset = "assets/slide38/slide38.png"; // <-- tu imagen
                  ...
                  child: Column(
                    ...
                    children: [
                      SlideTransition(
                        ...
                        child: _HeaderGlass(
                          scale: s,
                          title: "CTRL X CORE Automatización general",
                        ),
                      ),
                            ...
                            child: ConstrainedBox(
                              ...
                              child: _GlassCard(
                                ...
                                child: _CroppedImagePanel(
                                  ...
                                  // ✅ mata el borde celeste (ajusta si hace falta)
