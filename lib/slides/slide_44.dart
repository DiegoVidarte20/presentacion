// lib/slides/slide_44.dart
import 'dart:ui' show ImageFilter;
import 'package:flutter/material.dart';
import 'package:presentacion/ui/footer_band.dart';

class Slide44 extends StatefulWidget {
  const Slide44({super.key});

  @override
  State<Slide44> createState() => _Slide44State();
}

class _Slide44State extends State<Slide44> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    const imgAsset = "assets/slide44/slide44.png"; // <-- tu imagen
                            ...
                            child: ConstrainedBox(
                              ...
                              child: _GlassCard(
                                ...
                                child: _CroppedImagePanel(
                                  ...
                                  // ✅ esta imagen es full blanca alrededor: recortamos fuerte
                                  cropLeftFactor: 0.06,
                                  cropRightFactor: 0.06,
                                  cropTopFactor: 0.18,
                                  cropBottomFactor: 0.12,

                                  fit: BoxFit.cover, // ✅ para que llene
                                ),
                              ),
                            ),
                          ),
