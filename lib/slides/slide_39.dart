// lib/slides/slide_39.dart
import 'dart:ui' show ImageFilter;
import 'package:flutter/material.dart';
import 'package:presentacion/ui/footer_band.dart';

class Slide39 extends StatefulWidget {
  const Slide39({super.key});

  @override
  State<Slide39> createState() => _Slide39State();
}

class _Slide39State extends State<Slide39> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    const imgAsset = "assets/slide39/slide39.png"; // <-- tu imagen
                  ...
                  child: Column(
                    ...
                    children: [
                      SlideTransition(
                        ...
                        child: _HeaderGlass(
                          scale: s,
                          title: "CTRL X CORE Movimiento - Robótica",
                        ),
                      ),
                            ...
                            child: ConstrainedBox(
                              ...
                              child: _GlassCard(
                                ...
                                child: _CroppedImagePanel(
                                  ...
                                  // ✅ mata el borde celeste (ajusta si tu PNG difiere)
...
// Recorta % del ancho/alto (sin editar el archivo).
