...
class _Slide24State extends State<Slide24> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ Cambia a tu imagen real del slide 24
    const rightImage = "assets/slide24/slide24.png";
                                      ...
                                      children: [
                                        ...
                                        Positioned(
                                          ...
                                          child: _GlassLabelPill(
                                            s: s,
                                            text: "Arquitectura ctrlX MOTION",
                                          ),
                                        ),
...
class _LeftContentGlass extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("ctrlX MOTION", style: hStyle),
        ...
        _InnerGlassPanel(
          ...
          child: Text(
            "ctrlX MOTION se puede utilizar tanto en controladores como en unidades y permite una amplia variedad de aplicaciones.",
            style: base,
          ),
        ),
        ...
        Text(
          "Arquitectura basada en accionamiento",
          style: hStyle.copyWith(fontSize: 22 * s),
        ),
        SizedBox(height: 10 * s),
          ...
          child: _InnerGlassPanel(
            ...
            child: Column(
              ...
              children: [
                _BulletRichGlass(
                  s: s,
                  head: "Solución de control de movimiento",
                  body:
                      " que ahorra espacio: ctrlX CORE integrado en ctrlX DRIVE con EtherCAT maestro.",
                ),
                SizedBox(height: 10 * s),
                _BulletRichGlass(
                  s: s,
                  head: "EtherCAT maestro de alto rendimiento",
                  body:
                      " como bus de automatización para conectar la periferia.",
                ),
                SizedBox(height: 10 * s),
                _BulletRichGlass(
                  s: s,
                  head: "Apto para múltiples aplicaciones",
                  body:
                      " con un sistema de movimiento para diferentes máquinas y procesos.",
                ),
              ],
            ),
          ),
