// lib/slides/slide_45.dart
import 'dart:ui' show ImageFilter;
import 'package:flutter/material.dart';
import 'package:presentacion/ui/footer_band.dart';

class Slide45 extends StatefulWidget {
  const Slide45({super.key});

  @override
  State<Slide45> createState() => _Slide45State();
}

class _Slide45State extends State<Slide45> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    const imgAsset = "assets/slide45/slide45.png";
                  ...
                  child: Column(
                    ...
                    children: [
                      SlideTransition(
                        ...
                        child: _HeaderGlass(
                          scale: s,
                          title: "CTRL X CORE – Crea tu propia aplicación",
                        ),
                      ),
                            ...
                            child: ConstrainedBox(
                              ...
                              child: _GlassCard(
                                ...
                                child: _CroppedImagePanel(
                                  ...
                                  // ✅ recorte moderado: quita el aire blanco sin matar logos
                                  cropLeftFactor: 0.05,
                                  cropRightFactor: 0.05,
                                  cropTopFactor: 0.16,
                                  cropBottomFactor: 0.12,
